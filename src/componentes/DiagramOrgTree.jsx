...
const AREA_ADMIN = '#a21414';
const CTI_SECTION_NAVY = '#0B3D91';
const AREA_CTO = '#4eb9f7';
const AREA_COMERCIAL = '#db6115';
const AREA_OPERACION = '#5db935';
const AREA_EXPERIENCIA = '#d79b40';
const AREA_IA = '#3591b9';
const AREA_INFRA = '#2ebbc0';
const AREA_SAP = '#3900ab';
        ...
        <div className="org-tree-container holding-org">
            <div className="holding-org__main">
                ...
                <div className="holding-org__corporate">
                    ...
                    <section className="holding-org__panel holding-org__panel--adm">
                        <div className="org-tree-panel org-tree-panel--finance flex flex-col gap-1 holding-org__panel-inner" style={{ alignItems: 'center', boxSizing: 'border-box', padding: '5px 6px 6px' }}>
                            <div className="holding-org__headed-slice holding-org__headed-slice--cards-cols-4">
                                <div className="childrens-label-title org-tree-panel--finance-title" style={{ backgroundColor: AREA_ADMIN, textAlign: 'center', boxSizing: 'border-box' }}>
                    ...
                    <div className="holding-org__cti-block">
                    <div className="holding-org__cti-main-band">
                        <div
                            className="childrens-label-title holding-org__cti-main-title"
                            style={{ backgroundColor: CTI_SECTION_NAVY, textAlign: 'center', boxSizing: 'border-box' }}
                        >
                ...
                <section className="holding-org__cti">
                    ...
                    >
                        <div className="holding-org__cti-matrix">
                            <div className="holding-org__cti-row holding-org__cti-row--primary">
                                <div className="holding-org__cti-cell">
                                    <div className="holding-org__headed-slice holding-org__headed-slice--cards-cols-2">
                                        <div className="childrens-label-title holding-org__cti-cell-title" style={{ backgroundColor: AREA_CTO, textAlign: 'center', boxSizing: 'border-box' }}>
                                            Dirección de Tecnología (CTO)
                                        </div>
                                        <div className="org-tree-exec-cards-grid holding-org__cti-card-grid">
                                            <UserProfileCard color={AREA_CTO} name="Gilberto López Antonio" puesto="Dev. Web Senior" urlPhoto={dev1} onClickCV={() => handleDetails(10)} onClickProfile={() => handleDetails(10, 'DEV1.png')} min={min} />
                                            <UserProfileCard color={AREA_CTO} name="Ulises Cano Martínez" puesto="Dev. Mobile Senior" urlPhoto={dev2} onClickCV={() => handleDetails(12)} onClickProfile={() => handleDetails(12, 'DEV2.png')} min={min} />
                                            <UserProfileCard color={AREA_CTO} name="María José Carvajal Carrera" puesto="Dev. Web Junior" urlPhoto={DEV3M} onClickCV={() => handleDetails(13)} onClickProfile={() => handleDetails(13, 'DEV3M.jpg')} min={min} />
                                            <UserProfileCard color={AREA_CTO} name="Sergio Cano Martínez" puesto="Dev. Web Senior" urlPhoto={DEV4} onClickCV={() => handleDetails(21)} onClickProfile={() => handleDetails(21, 'DEV4.jpg')} min={min} />
                                            <div className="org-tree-exec-span2" style={{ gridColumn: '1 / 3', display: 'flex', justifyContent: 'center' }}>
                                                <UserProfileCard color={AREA_CTO} name="Rafael Cano Martínez" puesto="Dev. Full Stack" urlPhoto={DEV5} onClickCV={() => handleDetails(22)} onClickProfile={() => handleDetails(22, 'DEV5.jpg')} min={min} />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="holding-org__cti-cell">
                                    <div className="holding-org__headed-slice holding-org__headed-slice--cards-cols-2">
                                        <div className="childrens-label-title holding-org__cti-cell-title" style={{ backgroundColor: AREA_OPERACION, textAlign: 'center', boxSizing: 'border-box' }}>
                                            Dirección de operaciones (COO)
                                        </div>
                                        <div className="org-tree-exec-cards-grid holding-org__cti-card-grid">
                                            <UserProfileCard color={AREA_OPERACION} name="Julio César Castillo Z." puesto="Dirección de Operaciones" urlPhoto={ITS1} onClickCV={() => handleDetails(20)} onClickProfile={() => handleDetails(20, 'ITS1.png')} min={min} />
                                            <UserProfileCard color={AREA_OPERACION} name="Jorge Luis Olmos" puesto="Soporte en sitio" urlPhoto={SOPORTE} onClickCV={() => handleDetails(30)} onClickProfile={() => handleDetails(30, 'SOPORTE.jpg')} min={min} />
                                            <UserProfileCard color={AREA_OPERACION} name="Luis Alberto Ruiz Aguilar" puesto="Capacitación" urlPhoto={curso1} onClickCV={() => handleDetails(18)} onClickProfile={() => handleDetails(18, 'curso1.png')} min={min} />
                                            <UserProfileCard color={AREA_OPERACION} name="Víctor Ricardo Mojica" puesto="ITS / Peaje" urlPhoto={ITS2} onClickCV={() => handleDetails(19)} onClickProfile={() => handleDetails(19, 'ITS2.png')} min={min} />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="holding-org__cti-cell">
                                    <div className="holding-org__headed-slice holding-org__headed-slice--cards-cols-2">
                                        <div className="childrens-label-title holding-org__cti-cell-title" style={{ backgroundColor: AREA_EXPERIENCIA, textAlign: 'center', boxSizing: 'border-box' }}>
                                            Dirección de Experiencia (CX)
                                        </div>
                                        <div className="org-tree-exec-cards-grid holding-org__cti-card-grid">
                                            <UserProfileCard color={AREA_EXPERIENCIA} name="Jose Manuel Bravo Valencia" puesto="Gerente de Mesa de Ayuda" urlPhoto={MESA1M} onClickCV={() => handleDetails(23)} onClickProfile={() => handleDetails(23, 'MESA1M.jpg')} min={min} />
                                            <UserProfileCard color={AREA_EXPERIENCIA} name="Abigail Gabriela Vilchis M." puesto="Técnico Mesa de Ayuda" urlPhoto={MESA2} onClickCV={() => handleDetails(24)} onClickProfile={() => handleDetails(24, 'MESA2.jpg')} min={min} />
                                            <UserProfileCard color={AREA_EXPERIENCIA} name="Nicolás Bravo Vilchis" puesto="Técnico Mesa de Ayuda" urlPhoto={MESA3} onClickCV={() => handleDetails(25)} onClickProfile={() => handleDetails(25, 'MESA3.jpg')} min={min} />
                                            <UserProfileCard color={AREA_EXPERIENCIA} name="Lilia Marquéz Samano" puesto="Técnico Mesa de Ayuda" urlPhoto={MESA4} onClickCV={() => handleDetails(29)} onClickProfile={() => handleDetails(29, 'MESA4.jpeg')} min={min} />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="holding-org__cti-cell">
                                    <div className="holding-org__headed-slice holding-org__headed-slice--cards-cols-2">
                                        ...
                                        <div className="org-tree-exec-cards-grid holding-org__cti-card-grid">
                                            <UserProfileCard color={AREA_IA} name="Pablo Tlaxcoapan" puesto="Ing. Dev. IA" urlPhoto={IA1} onClickCV={() => handleDetails(15)} onClickProfile={() => handleDetails(15, 'IA1.png')} min={min} />
                                ...
                                <div className="holding-org__cti-cell">
                                    <div className="holding-org__headed-slice holding-org__headed-slice--cards-cols-2">
                                        ...
                                        <div className="org-tree-exec-cards-grid holding-org__cti-card-grid">
                                            <UserProfileCard color={AREA_COMERCIAL} name="Héctor Julián Rabadán Tapia" puesto="Dirección Comercial" urlPhoto={DCOMERCIAL1} onClickCV={() => handleDetails(27)} onClickProfile={() => handleDetails(27, 'DCOMERCIAL1.png')} min={min} />
                                ...
                                <div className="holding-org__cti-cell">
                                    <div className="holding-org__headed-slice holding-org__headed-slice--cards-cols-2">
                                        ...
                                        <div className="org-tree-exec-cards-grid holding-org__cti-card-grid">
                                            <UserProfileCard color={AREA_SAP} name="Norma Barbosa" puesto="Consultor SAP MM/FI/SD" urlPhoto={SAP1} onClickCV={() => handleDetails(8)} onClickProfile={() => handleDetails(8, 'SAP1.png')} min={min} />
                                            <UserProfileCard color={AREA_SAP} name="Francisco J. Mejía Ra." puesto="Consultor Consultor SAP-ABAP" urlPhoto={SAP2} onClickCV={() => handleDetails(9)} onClickProfile={() => handleDetails(9, 'SAP2.png')} min={min} />
                                        </div>
                                    </div>
                                </div>
                            </div>
