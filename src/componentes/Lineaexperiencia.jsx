...
function Lineaexperiencia() {
  return (
    <div>
      <h2 style={{ textAlign: 'left', color: '#00152', fontSize: '18px', marginLeft: '30px',fontFamily:'customFont',fontWeight:'bold'}}>Experiencia</h2>
...
export default Lineaexperiencia;